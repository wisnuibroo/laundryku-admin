    ...
    <div className="flex-1 overflow-auto">
      ...
      <div className="p-6">
        ...
        <div className="flex gap-4 mb-6">
          <button onClick={() => navigate("")} className="flex items-center gap-2 px-4 py-2 rounded border border-gray-300 bg-white text-black font-semibold shadow">
            <Icon icon="mdi:credit-card-outline" width={18} />Bulanan
          </button>
          <button onClick={() => navigate("")} className="flex items-center gap-2 px-4 py-2 rounded bg-red-600 text-white font-semibold shadow">
      ...
      <h2 className="text-gray-600">Pendapatan, pengeluaran, dan laba 6 bulan terakhir</h2>

      <div className="space-y-6 mt-6">
        {reports.map(({ month, pendapatan, pengeluaran, laba }) => {
          const margin = (laba / pendapatan) * 100;
          const progress = (pendapatan / 15000000) * 100; // asumsi skala max 15jt
