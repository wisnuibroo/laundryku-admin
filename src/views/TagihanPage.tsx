                  ...
                  <table className="w-full text-center">
                    <thead>
                      <tr className="bg-gray-10 text-gray-600 text-sm ">
                        ...
                        <th className="py-2 px-4">Tagihan</th>
                        <th className="py-2 pl-4 pr-8">Tagihan Bulan Ini</th>
                      </tr>
                    </thead>
                    ...
                    <tbody>
                      <tr className="bg-white rounded-[10px] text-sm text-black-600">
                        ...
                        <td className="py-3 px-4">Rp. 6000</td>
                        <td className="py-3 px-4 rounded-r-[19px]">Rp. 1.150.000</td>
                      </tr>
                    ...
                    <div className="mt-6"/> 
                      <tr className="bg-white rounded-[10px] text-sm text-black-600">
                        ...
                        <td className="py-3 px-4">Rp. 10.000</td>
                        <td className="py-3 px-4 rounded-r-[19px]">Rp. 620.000</td>
                      </tr>
                    ...
                    <div className="mt-6"/> 
                      <tr className="bg-white rounded-[10px] text-sm text-black-600">
                        ...
                        <td className="py-3 px-4">Rp. 130.000</td>
                        <td className="py-3 px-4 rounded-r-[19px]">Rp. 31.240.000</td>
                      </tr>
