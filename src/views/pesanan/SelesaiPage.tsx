        ...
        <div className="flex h-screen bg-white-100">
            ...
            <div className="flex-1 p-6">  
                ...
                <div className="mt-10 flex">
                 ...
                 <StatusButton title="Selesai" onClick={""} className="mx-2" />
               </div>
                  ...
                  <table className="w-full text-center">
                    ...
                    <tbody>
                      <tr className="bg-white rounded-[10px] text-sm text-black-600">  
                        ...
                        <td className="py-3 px-4">diam bil</td>         
                    ...
                    <div className="mt-6"/> 
                      <tr className="bg-white rounded-[10px] text-sm text-black-600">
                        ...
                        <td className="py-3 px-4">opotah bil bil</td>
                    ...
                    <div className="mt-6"/> 
                      <tr className="bg-white rounded-[10px] text-sm text-black-600">
                        ...
                        <td className="py-3 px-4">yo bil</td>
                        <td className="py-3 px-4">08974107410</td>
                        <td className="py-3 px-4=">
                          Jl. Bae-Gribig,Gribig,<br />
                          Kec. Gebog, Kabupaten Kudus, Jawa Tengah 59333
                    ...
                    <div className="mt-6"/> 
                      <tr className="bg-white rounded-[10px] text-sm text-black-600">
                        <td className="py-3 px-4 rounded-l-[19px]">4</td>
                        <td className="py-3 px-4">push bil</td>
                        <td className="py-3 px-4">08974107410</td>
                        <td className="py-3 px-4=">
                          Jl. Bae-Gribig,Gribig,<br />
                          Kec. Gebog, Kabupaten Kudus, Jawa Tengah 59333
